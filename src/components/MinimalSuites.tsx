...
export const MinimalSuites: React.FC = () => {
  ...
  return (
    <section id="suites" className="relative bg-[#fafaf7] text-[#0f172a] py-24 md:py-32 px-6 sm:px-10 lg:px-16 border-t border-[#e2e8f0]">
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          ...
          <div className="flex items-center gap-1.5 p-1 rounded-[12px] bg-white border border-[#e2e8f0] shadow-xs self-start md:self-auto">
            {SUITES_DATA.map((suite) => {
              ...
              return (
                <button
                  ...
                  className={`px-5 py-2 rounded-[8px] font-sans text-xs tracking-wider uppercase transition-all duration-200 relative cursor-pointer font-bold ${
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-7 relative rounded-[16px] overflow-hidden min-h-[360px] sm:min-h-[460px] lg:min-h-[520px] shadow-sm border border-[#e2e8f0] bg-[#0f172a]">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="absolute bottom-6 left-6 right-6 z-10">
                  ...
                  <p className="font-serif text-2xl sm:text-3xl text-white font-bold italic [text-shadow:0_1px_3px_rgba(0,0,0,0.6)]">
          ...
          <div className="lg:col-span-5 bg-white border border-[#e2e8f0] rounded-[16px] shadow-sm p-6 sm:p-8 flex flex-col justify-between space-y-6">
