...
export const MinimalVillaStory: React.FC = () => {
  ...
  return (
    <section id="villa" className="relative bg-[#fafaf7] text-[#0f172a] py-24 md:py-32 px-6 sm:px-10 lg:px-16 border-t border-[#e2e8f0]">
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-5 space-y-3">
            {pillars.map((pillar, idx) => (
              <div
                ...
                className={`w-full text-left p-5 sm:p-6 rounded-[16px] transition-all duration-300 cursor-pointer overflow-hidden border ${
                  activeTab === idx
              ...
              >
                ...
                <h3 className="font-sans text-lg sm:text-xl text-[#0f172a] mb-1.5 font-bold">
                  {pillar.title}
                </h3>
          ...
          {/* Right: Smooth Cross-Fading Architectural Image Stage */}
          <div className="lg:col-span-7 relative h-[400px] sm:h-[480px] lg:h-[540px] rounded-[16px] overflow-hidden shadow-md border border-[#e2e8f0] bg-[#0f172a]">
              ...
              >
                ...
                <div className="absolute bottom-6 left-6 right-6 flex items-end justify-between text-white">
                  <div className="space-y-1">
                    <span className="font-mono text-[10px] tracking-widest text-white/90 uppercase block font-semibold">
                      {pillars[activeTab].aspect}
                    </span>
                    <p className="text-xl sm:text-2xl font-bold [text-shadow:0_1px_3px_rgba(0,0,0,0.5)]">
                      {pillars[activeTab].title}
                    </p>
                  </div>
                  <div className="font-mono text-xs text-white/80 font-semibold">
                    0{activeTab + 1} / 04
                  </div>
                </div>
              </motion.div>
